...
*/
	...
	define('QA_MYSQL_HOSTNAME', HTTP_BAE_ENV_ADDR_SQL_IP.':'.HTTP_BAE_ENV_ADDR_SQL_PORT); 
	define('QA_MYSQL_USERNAME', HTTP_BAE_ENV_AK);
	define('QA_MYSQL_PASSWORD', HTTP_BAE_ENV_SK);
	define('QA_MYSQL_DATABASE', 'OsXBhrTZnzlFVRGwEGWf');
