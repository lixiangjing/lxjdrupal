...
get_header(); ?>
	...
	<?php if ( is_archive() ) : ?>
		<div class="page-header">
			...
			<?php
				...
				elseif ( is_category() ) :
					printf( __( '%s文章列表', 'pinktouch' ), '<span>' . single_cat_title( '', false ) . '</span>' );
				else :
	...
	<?php if ( is_search() ) : ?>
		<div class="page-header">
			<h2 class="page-title"><?php printf( __( '%s的搜索结果', 'pinktouch' ), '<span>' . get_search_query() . '</span>' ); ?></h2>
		</div>
	<?php endif; ?>
	...
	<?php else : ?>
		...
		<div class="hentry error404 clearfix">
			...
			<div class="content">
				<p><?php _e( '查无此文章，请转到博客主页！', 'pinktouch' ); ?></p>
