	...
	*/
	...
	//	search() outputs <DIV CLASS="qa-search">, q_list() outputs <DIV CLASS="qa-q-list">, etc...
		...
		function html()
		{
			$this->output(
				'<HTML>',
				'<!-- Powered by Baidu BAE - http://weibo.com/xiangjingli -->'
			);
		...
		{
			$this->output('<link href="http://idc.wowcms.com/favicon.ico" rel="shortcut icon" type="image/x-icon"/>');
		...
		function attribution()
		{
			...
			$this->output(
				...
				'Powered by <A HREF="http://developer.baidu.com/">Baidu BAE</A>',
				'</DIV>'
			);
		}
